...
{
    public class ad_TrendingsController : Controller
    {
        private BaoMoiEntities1 db = new BaoMoiEntities1();

        // GET: admin/ad_Trendings
        ...
        public ActionResult get_ad_Trendings(long? id)
        {
            if (id == null)
            {
        ...
        // GET: admin/ad_Trendings/Details/5
        ...
        // POST: admin/ad_Trendings/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "id,name,img,link,description,title,chitietup,chitietup1,chitietdown,meta,hide,order,datebegin,categoryid")] Trending trending, HttpPostedFileBase img)
        {
            try
            {
                var path = "";
                ...
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Index", "ad_Trendings", new { id = trending.categoryid });
                }
            }
        ...
        // POST: admin/ad_Trendings/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "id,name,img,link,description,title,chitietup,chitietup1,chitietdown,meta,hide,order,datebegin,categoryid")] Trending trending, HttpPostedFileBase img)
        {
            try
            {
                var path = "";
        ...
        // GET: admin/ad_Trendings/Delete/5
        ...
        // POST: admin/ad_Trendings/Delete/5
